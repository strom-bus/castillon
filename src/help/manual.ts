        ...
        terms: [
          {
            ...
            text: {
              en: 'Four of the oscillator’s own settings can be taken over by a single step: its Wave, Cutoff, Gate and Decay. Each one follows the oscillator until you move it, and from then on that step keeps its own — so a line of sixteen squares can have one sawtooth in it, or one note that rings while the other fifteen are clipped short. The box beside the name says which. Tick it and the step takes the value it was already showing, which changes nothing you can hear until you move it; untick it and the control goes back to following the oscillator.',
              es: 'Cuatro de los ajustes del propio oscilador los puede tomar prestados un solo paso: su Wave, Cutoff, Gate y Decay. Cada uno sigue al oscilador hasta que lo mueves, y desde entonces ese paso se queda con el suyo — así una línea de dieciséis cuadradas puede tener una sierra dentro, o una nota que resuena mientras las otras quince quedan cortadas. La casilla al lado del nombre dice cuál. Márcala y el paso se queda con el valor que ya estaba mostrando, así que marcar no cambia nada que puedas oír hasta que lo muevas; desmárcala y el control vuelve a seguir al oscilador.',
            },
          },
          {
